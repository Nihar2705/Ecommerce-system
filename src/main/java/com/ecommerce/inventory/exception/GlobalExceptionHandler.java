...
public class GlobalExceptionHandler {
    ...
    // ---------- New handlers added in Version 6 (Product Image Upload) ----------

    // Uploaded file was empty / no file selected
    ...
    // Uploaded file is not a JPG/JPEG/PNG image
    ...
    // Uploaded file exceeds 5 MB (checked explicitly in the service layer)
    ...
    // Uploaded file exceeds 5 MB, rejected by Spring's multipart resolver before
    // reaching the controller (spring.servlet.multipart.max-file-size)
    ...
    // Product has no image, or the referenced image file could not be found on disk
    ...
    // Unexpected I/O failure while storing/reading/deleting an image on the file system
